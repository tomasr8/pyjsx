...
I use the Python grammar almost without any modifications and add the JSX grammar at the end and extend the `expression` rule:
...
This is the README for your extension "pyjsx". After writing up a brief
